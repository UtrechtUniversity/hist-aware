"""
From https://github.com/UKPLab/sentence-transformers/blob/master/examples/applications/semantic_search_quora_hnswlib.py
"""
...
if __name__ == "__main__":
    ...
    # Import data
    model_path = "../data/models/distiluse-base-multilingual-cased"
    ...
    embedding_cache_path = "embeddings-{}-size-{}.pkl".format(
