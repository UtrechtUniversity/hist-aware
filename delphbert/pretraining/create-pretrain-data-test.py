...
DEST_PATHS = ['/home/leonardovida/data/volume_1/delphbert-results/3-pretraining_data_cased/1960/tf_pretrain_{}.tfrecord'.format(i) for i in range(63)]
...
def create_training_instances(input_files, tokenizer, max_seq_length,
    ...
    for count, input_file in enumerate(input_files):
        ...
        if (count == 0):
            start_count = count
            finish_count = count + 2
        else:
            start_count = count + 2
            finish_count = start_count + 2
        paths = DEST_PATHS[start_count:finish_count]
        ...
        write_instance_to_example_files(instances, tokenizer, MAX_SEQ_LENGTH, MAX_PRED_PER_SEQ, paths)
